...
- [https://cgi.cse.unsw.edu.au/~cs1531/26T2/practice-exam2/](https://cgi.cse.unsw.edu.au/~cs1531/26T2/practice-exam2/)
...
![Red arrow pointing to the "Fork" button at the top-right of the page, on the right of the "Star" button.](/assets/create-a-fork.png)

![Filled out create a fork form. With namespace set to student zid, branches set to only copy the default, and visibility set to private.](assets/fork-namespace.png)
